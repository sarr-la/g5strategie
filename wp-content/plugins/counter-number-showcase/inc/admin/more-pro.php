	...
	<div class="col-md-12">
		...
		<div class="col-md-4"> 
				...
				<div class="wpsm-theme-container" style="">
					<img width="700" height="394" src="<?php echo wpshopmart_cns_directory_url.'assets/images/teams-pro.png'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="tabs pro plugin">
		...
		<div class="col-md-4"> 
				...
				<div class="wpsm-theme-container" style="">
					<img width="700" height="394" src="<?php echo wpshopmart_cns_directory_url.'assets/images/cb.png'; ?>" class="wpsm_site-img-responsive wp-post-image" >
					<div class="wpsm_product_wrapper">
		...
		<div class="col-md-4"> 
				...
				<div class="wpsm-theme-container" style="">
					<img width="700" height="394" src="<?php echo wpshopmart_cns_directory_url.'assets/images/csp.png'; ?>" class="wpsm_site-img-responsive wp-post-image" >
					<div class="wpsm_product_wrapper">
		...
		<div class="col-md-4"> 
				...
				<div class="wpsm-theme-container" style="">
					<img width="700" height="394" src="<?php echo wpshopmart_cns_directory_url.'assets/images/ac.png'; ?>" class="wpsm_site-img-responsive wp-post-image" >
					<div class="wpsm_product_wrapper">
		...
		<div class="col-md-4"> 
				...
				<div class="wpsm-theme-container" style="">
					<img width="700" height="394" src="<?php echo wpshopmart_cns_directory_url.'assets/images/tabs-pro-screesnhot.png'; ?>" class="wpsm_site-img-responsive wp-post-image" >
					<div class="wpsm_product_wrapper">
						<h3  style="width:70%">Tabs Pro </h3>
						<span class="price"><span class="amount"></span></span>
						<div class="wpsm-btn-block" style="">
		...
		<div class="col-md-4"> 
				...
				<div class="wpsm-theme-container" style="">
					<img width="700" height="394" src="<?php echo wpshopmart_cns_directory_url.'assets/images/service-showcase-pro-preview.jpg'; ?>" class="wpsm_site-img-responsive wp-post-image" >
					<div class="wpsm_product_wrapper">
						<h3  style="width:70%">Service Showcase Pro</h3>
						<span class="price"><span class="amount"></span></span>
						<div class="wpsm-btn-block" style="">
